            ...
            <div className="overflow-x-auto">
              <table className="data-table min-w-[680px]">
                ...
                <tbody>
                  {items.map((a) => (
                    <tr key={a.id}>
                      <td className="text-[13.5px] font-semibold text-white">{a.name}</td>
                      <td className="font-mono text-[12px] text-[#94A3B8]">{a.code}</td>
                      <td className="max-w-[260px] truncate text-[13px] text-[#94A3B8]">{a.description ?? "—"}</td>
                      <td>
