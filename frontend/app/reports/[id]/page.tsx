        ...
        <li key={s.label} className="timeline-item">
          ...
          <span className="min-w-0">
            <span className="block text-[13.5px] font-semibold text-white">
              {s.label} {s.current ? <span className="text-[11px] font-medium text-[#00E5FF]">· current</span> : null}
            </span>
              ...
              <div className="flex flex-wrap items-start justify-between gap-4">
                <div className="min-w-0">
                  <div className="flex flex-wrap items-center gap-2">
                    <h1 className="font-mono text-[22px] font-bold tracking-tight text-white sm:text-[24px]">{report.reportNumber}</h1>
            ...
            <div className="grid grid-cols-1 gap-5 lg:grid-cols-5">
              ...
              <div className="space-y-5 lg:col-span-3">
                ...
                <section className="panel">
                  ...
                  <div className="panel-body">
                    <blockquote className="whitespace-pre-wrap rounded-xl border border-white/[0.06] border-l-4 border-l-[#0F172A] bg-white/[0.04] px-5 py-4 text-[14px] leading-relaxed text-white">
                      {report.description}
                    </blockquote>
                  </div>
                </section>
                ...
                <section className="panel" id="hse-review">
                  ...
                  <div className="panel-body">
                    {report.status === "CLOSED" && report.aiAnalysis?.route === "AUTO_CLOSE" && !(report as unknown as { latestReview?: unknown }).latestReview ? (
                      ...
                      <p className="text-[13.5px] text-[#64748B]">This report is closed — workflow complete.</p>
                    ) : (
