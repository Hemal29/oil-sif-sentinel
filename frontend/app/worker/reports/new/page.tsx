...
const labelCls = "mb-1 block text-xs font-semibold uppercase tracking-wide text-[#94A3B8]";
      ...
      <main className="page-canvas">
        ...
        <div className="mx-auto w-[min(100%-2rem,720px)] py-6">
          <section className="panel p-6 sm:p-8" aria-live="polite">
            ...
            <dl className="mt-4 space-y-2 border-t border-white/[0.05] pt-4 text-sm">
              <div className="flex justify-between gap-4">
                <dt className="text-[#94A3B8]">Report number</dt>
                <dd className="font-semibold text-white">{created.reportNumber}</dd>
              </div>
              <div className="flex justify-between gap-4">
                <dt className="text-[#94A3B8]">Status</dt>
                <dd className="font-semibold text-white">Submitted</dd>
              </div>
            </dl>
        ...
        <form onSubmit={onSubmit} noValidate className="mt-5 space-y-5" aria-label="Submit safety report">
                  ...
                  return (
                    <label
                      ...
                      className={`cursor-pointer rounded-md border px-3 py-2.5 transition-colors ${
                        selected ? "border-[#00E5FF] bg-[rgba(0,229,255,0.08)] ring-1 ring-blue-700" : "border-white/[0.06] bg-[#131B24] hover:border-slate-300"
                      }`}
                    >
                      <span className="flex items-start gap-2">
                        ...
                        <span>
                          ...
                          <span className="block text-xs text-[#94A3B8]">{o.hint}</span>
                        </span>
                      </span>
                    </label>
                  );
          ...
          <Card title="What Happened" subtitle="Factual details of what you observed.">
            <div data-error={Boolean(errors.description)}>
              ...
              />
              <p id="worker-description-help" className="mt-1 text-[13px] text-[#94A3B8]">
