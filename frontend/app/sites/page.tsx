        ...
        {admin ? (
          <Card title="Create Site" subtitle="Add a new operational location (HSE Admin)">
            <form onSubmit={onCreate} className="grid grid-cols-1 gap-4 sm:grid-cols-2">
              ...
              <label className="block">
                <span className="mb-1.5 block text-[13px] font-semibold text-white">Location</span>
            ...
            <div className="overflow-x-auto">
              <table className="data-table min-w-[720px]">
                ...
                <tbody>
                  {items.map((s) => (
                    <tr key={s.id}>
                      <td className="text-[13.5px] font-semibold text-white">{s.name}</td>
                      <td className="font-mono text-[12px] text-[#94A3B8]">{s.code}</td>
                      <td className="max-w-[220px] truncate text-[13px] text-[#94A3B8]">{s.location ?? "—"}</td>
                      <td>
